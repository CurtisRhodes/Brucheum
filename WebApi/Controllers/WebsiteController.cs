...
namespace WebApi
{
    ...
    public class SiteUserController : ApiController
    {
        ...
        [HttpPut]
        public string Update(SiteUser model)
        {
            ...
            try
            {
                using (WebSiteContext db = new WebSiteContext())
                {
                    SiteUser user = db.SiteUsers.Where(s => s.IPAddress == model.IPAddress).FirstOrDefault();
                    if (user != null)
                    {
        ...
        //[HttpPost]
        //public string CustomLogin(SiteUser model)
        //{
        //    string success = "";
        //    try
        //    {
        ...
        //            newUser.IPAddress = model.IPAddress;
