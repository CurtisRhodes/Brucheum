...
namespace Brucheum
{
    ...
    {
        public ApplicationRoleManager(IUserStore<ApplicationUser> store)
            : base(store)
        {
        }
        ...
        //        var roleStore = new RoleStore<IdentityRole>(context);
        //        var roleManager = new RoleManager<IdentityRole>(roleStore);
        //        IQueryable<IdentityRole> idRoles = roleManager.Roles;
        //    }
        //    return roles;
        //}

        public IdentityResult AddUserRole(string roleName, string userId)
        {
            Claim claim = new Claim(ClaimTypes.Role, roleName);
            return this.AddClaim(userId, claim);
        }
