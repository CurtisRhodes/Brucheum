/*1538236444,,JIT Construction: v4367099,en_US*/
...
try {
	window.FB || (function (window, fb_fif_window) {
		...
		for (var i = 0; i < sandboxWhitelist.length; i++) {
			...
			with (this) {
				...
				__d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKConfig", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.domReady", "sdk.ErrorHandling", "sdk.Insights", "sdk.Runtime", "sdk.Scribe"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
					__p && __p();
					var u = window.FB = {},
						v, w = l(i, "api.mode"),
						x = {};
					...
					g.setRoot(y);
					p(function () {
						k.info("domReady"), n.appendHidden(y), j.rules && o.addCssRules(j.rules, j.components)
					});
					s.subscribe("AccessToken.change", function (a) {
						!a && s.getLoginStatus() === "connected" && m.getLoginStatus(null, !0)
					});
					l(i, "api.whitelist.length") && (v = {}, ES(i.api.whitelist, "forEach", !0, function (a) {
						v[a] = 1
					}));
						...
						switch (e) {
							...
							default:
								return q.guard(function () {
									__p && __p();
									e === "warn" && (k.warn("The method FB.%s is not officially supported by Facebook and access to it will soon be removed.", b), Object.prototype.hasOwnProperty.call(x, b) || (r.log(r.TYPE.WARNING, r.CATEGORY.DEPRECATED, "FB." + b), t.log("jssdk_error", {
										appId: s.getClientID(),
				...
				__d("sdk.unsecureDisallowed", ["Log", "sdk.feature", "sdk.Runtime", "sdk.Scribe"], (function (a, b, c, d, e, f, g, h, i, j) {
					...
					function a(a) {
						...
						if (location.protocol !== "https:" && k) {
							...
							b > 30 ? g.log("warn", -1, "The method FB.%s will stop working when called from http pages in %s days.  Please update your site to use https for Facebook Login. %s", a, Math.floor((k - ES("Date", "now", !1)) / 864e5), l) : g.log("error", -1, "The method FB.%s will stop working when called from http pages in %s days.  Please update your site to use https for Facebook Login. %s", a, Math.floor((k - ES("Date", "now", !1)) / 864e5), l);
							h("https_only_scribe_logging", !0) && !Object.prototype.hasOwnProperty.call(m, a) && (j.log("jssdk_error", {
								appId: i.getClientID(),
								error: "HttpsOnly",
								extra: {
									message: a
				...
				__d("URI", ["PHPQuerySerializer", "ReloadPage", "URIBase", "areSameOrigin", "ifRequired", "isFacebookURI", "memoize", "unqualifyURI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
					...
					r.getMostRecentURI = function () {
						"use strict";
						var a = q();
						return a ? a.getMostRecentURI().getQualifiedURI() : new r(window.location.href)
					};
					r.getNextURI = function () {
						"use strict";
						var a = q();
						return a ? a.getNextURI().getQualifiedURI() : new r(window.location.href)
					};
				...
				__d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j) {
					...
					if (l) {
						...
						b && (n.fetchTime = Number(b.duration), a && (n.fetchTime += Number(a.duration)), "transferSize" in b && (n.transferSize = Number(b.transferSize), a && (n.transferSize += Number(a.transferSize))), g.debug("sdkperf: it took %s ms and %s bytes to load %s", n.fetchTime, n.transferSize, o), m = b.startTime, n.ns = j.getSDKNS(), m && setTimeout(function () {
							var a = h("log_perf", !1),
								b = j.getSDKAB();
							b && (n.ab = b, (b === "yn" || b === "ny") && (a = h("log_perf_devsite", !1)));
							a && i.log(116, n)
						}, 1e4))
					}
					d = {
	...
	new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4367099","namespace":"FB","message":"' + e.message + '"}}');
}